...
namespace DBFirstAppEF.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(DormDatabaseContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,PhoneNumber,EMail,UserName,Password,PictureFilePath,IsDeleted")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DormDatabaseContext.Users'  is null.");
            }
            var user = await _context.Users.FindAsync(id);
            if (user != null)
            {
